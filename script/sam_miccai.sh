...
# exec
srun -N 2 -n 16 --ntasks-per-node 8 /lustre/orion/bif146/world-shared/gvit/env/miniconda3/envs/gvit/bin/python ./train/sam_miccai.py \
        ...
        --patch_size=8 \
        --pretrain=sam-b \
        --savefile=./sam-b_miccai-n2-pz8-bz4-nomalize