...
# exec
srun -N 16 -n 128 --ntasks-per-node 8 /lustre/orion/bif146/world-shared/gvit/env/miniconda3/envs/gvit/bin/python ./train/sam_miccai.py \
        ...
        --patch_size=8 \
        --pretrain=sam-b \
        --savefile=./sam-b_miccai-n16-pz8-bz4-nomalize-rddp-lr2